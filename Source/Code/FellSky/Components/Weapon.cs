...
namespace FellSky.Components
{
    ...
    public class Weapon : Component, ICmpUpdatable, ICmpInitializable
    {
        ...
        {
            var animators = GameObj.GetComponentsDeep<SpriteAnimator>();
            foreach(var anim in animators)
            {
                anim.AnimDuration = CycleTime;
                anim.AnimTime = 0;
                anim.AnimLoopMode = SpriteAnimator.LoopMode.FixedSingle;
            }
        ...
        {
            var anims = GameObj.GetComponentsDeep<SpriteAnimator>();
            switch (Status)
            {
                ...
                case WeaponStatus.Reloading:
                    var evt = new WeaponReloadEvent(this);
        ...
        public void Fire(int index)
        {
            ...
            var projComponent = projectile.GetComponent<IProjectile>();
